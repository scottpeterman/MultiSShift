...
from multisshift.utils.util import cryptonomicon
# from uglyptyvt.terminal.tabterm import TabTerminal
...
class CredentialsDialog(QDialog):
    ...
    def get_credentials_from_db(self, cred_id):
        ...
        if credentials:
            ...
            password_encrypted = credentials[1].strip()
            password = cryptonomicon(password_encrypted)
        else:
            username = None
            password = None
        conn.close()
