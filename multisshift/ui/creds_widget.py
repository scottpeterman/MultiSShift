...
from multisshift.ui.creds_dlg import Ui_dlgCreds
from multisshift.utils.models import Cred
from multisshift.utils.db import get_by_dbquery
from sqlalchemy import create_engine, text
from sqlalchemy.orm import Session
# from uglypty.Library.creds_dlg import Ui_dlgCreds
import json
from multisshift.utils.util import cryptonomicon, encrypt
...
class CredentialsManagerWidget(QtWidgets.QWidget):
    ...
    def tw_right_click(self):
        ...
        if not os.path.exists(db_path):
            from multisshift.utils.db import create_db
            create_db()
    ...
    def creds_add(self):
        ...
        if result == 1:
            ...
            stub_item['Password'] = encrypt(stub_item['Password'])
            stub_item['Password'] = stub_item['Password'].decode('utf-8')
